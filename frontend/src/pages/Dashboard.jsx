      ...
      <div className="main-content">
        ...
        <div className="page-body animate-fade">
          ...
          <div className="kpi-grid" style={{ gridTemplateColumns: 'repeat(4, 1fr)', gap: 16, marginBottom: 24 }}>
            ...
            <div className="card" style={{ padding: 20, borderRadius: 16, background: 'var(--bg-card)', border: '1px solid var(--border)' }}>
              <div style={{ fontSize: '0.8rem', fontWeight: 600, color: 'var(--text-muted)', marginBottom: 6 }}>RESOLVED</div>
              <div style={{ fontSize: '1.8rem', fontWeight: 800, color: 'var(--success)' }}>{stats.resolved}</div>
              <div style={{ fontSize: '0.75rem', color: 'var(--success)', marginTop: 4 }}>Completed work</div>
            </div>
          </div>
